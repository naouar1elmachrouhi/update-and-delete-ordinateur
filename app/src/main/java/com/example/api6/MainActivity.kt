    ...
    fun getDATA() {
        ...
        call.enqueue(object : Callback<List<Ordinateur>> {
            override fun onResponse(
                call: Call<List<Ordinateur>>,
                response: Response<List<Ordinateur>>
            ) {
                if (response.isSuccessful) {
                    ...
                    list_view.setOnItemClickListener{parent, view, position, id ->
                        ...
                        val intent = Intent(this@MainActivity, up_del::class.java).also {
            ...
            override fun onFailure(call: Call<List<Ordinateur>>, t: Throwable) {
                Toast.makeText(this@MainActivity, "Echec de la cennexion", Toast.LENGTH_SHORT)
                    .show()
            }
        })
